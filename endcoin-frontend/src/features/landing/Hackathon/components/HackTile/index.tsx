...
const MentorTile = ({
  ...
  return (
    ...
    >
      <div
        className={`w-full h-full max-h-fit px-[30px] flex flex-col  justify-center rounded cardFront text-white ${
          item.id === '00' ? 'px-0 font-bold' : ''
        }`}
      >
        ...
        <p className="text-[14px] endcoin-md:text-[18px]">{item.subtitle}</p>
      </div>

    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <p className="mt-6 text-xl leading-8">
          To promote sustainable economic growth and support green technologies,
          we propose the use of sea surface temperature data as a monitoring
          tool for Earth's overall health. By harnessing decentralized data
          networks and blockchain technology, we aim to restore sovereignty to
          the Earth and encourage responsible decision-making for the betterment
          of our planet.
        </p>
        <div className="mt-10 max-w-2xl">
            ...
            <li>
              ...
              <ul className="pl-10">
                ...
                <li>
                  ...
                  data and submit to oracle. Endcoin/Gaiacoin delivered to these
                  proovers.
                </li>
          ...
          <ul className="list-disc list-outside [&_ul]:list-[revert]">
            <li>
              ...
              <ul className="pl-10">
                <li>Anyone can compute SST from data, and prove with hash.</li>
                <li>
